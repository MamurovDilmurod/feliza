...
const Footer = () => {
  ...
  return (
    <div className="max-w-[1280px] mx-auto pt-24 pb-10 px-4 font-tenor">
      ...
      {/* Footer Links 1 */}
      <div className='flex flex-wrap justify-center gap-x-6 gap-y-3 pt-10 pb-5 text-center max-w-[1280px] mx-auto'>
        ...
        <Link to="/contact" className='text-[#0D0D0D] hover:underline cursor-pointer'>
